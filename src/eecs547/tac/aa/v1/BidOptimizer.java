...
public class BidOptimizer {
    ...
    public void updateBid() {
        ...
        if (firstBid) {
            Product target = null;
            if (bM.agent.advertiserInfo.getManufacturerSpecialty().equals(query.getManufacturer()) && bM.agent.advertiserInfo.getManufacturerBonus() > 0 && bM.agent.advertiserInfo.getComponentSpecialty().equals(query.getComponent()) && bM.agent.advertiserInfo.getComponentBonus() > 0) {
