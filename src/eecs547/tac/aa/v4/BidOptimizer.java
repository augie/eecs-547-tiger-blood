...
public class BidOptimizer {
    ...
    public static final double MOVEMENT = 0.035, PERCENT_INITIAL_BID_F0 = 0.04, PERCENT_INITIAL_BID_F1 = 0.075, PERCENT_INITIAL_BID_F2 = 0.1, PERCENT_INITIAL_BID_SPECIAL = 0.11;
    public BidModel bM;
    public Query query;
    public Bid bid;
